...
class CNNTransformer(nn.Module):
    def __init__(self):
        ...
        #    d_input = 64, d_model = 32, n_head = 2, num_encoder_layers = 1, num_decoder_layers = 1, dim_feedforward = 32, output_class = 36 + 4
    ...
    def forward(self, x, tgt, tgt_length):
        ...
        :return logits: logits with size [max_len, b, 40], w is the width of feature maps extracted by CNN
        '''
        feats = self.cnn(x)
